                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr class="border-b bg-gray-50 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">
                            ...
                            <th class="px-4 py-3">Attribué à</th>
                            @endhasanyrole
                            <th></th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y">
                        ...
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 space-x-2">
                                ...
                                @endrole
                                <a class="rounded-lg border-2 border-transparent bg-blue-600 px-4 py-2 text-center text-sm font-medium leading-5 text-white transition-colors duration-150 hover:bg-blue-700 focus:outline-none focus:ring active:bg-blue-600"
